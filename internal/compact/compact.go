// Package compact implements MygoCode's Layer 2 context management:
...
func ManageContext(
	...
	// 对齐 Claude Code：用 budget 裁剪后的消息做 token 估算，
...
func autoCompact(
	...
	// 对齐 Claude Code：优先使用 budget 裁剪后的消息做摘要和 token 估算，
	// 避免摘要请求因包含未裁剪的大工具结果而超出上下文窗口。
