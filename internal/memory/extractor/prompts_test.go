...
func TestBuildExtractAutoOnlyPromptMarkers(t *testing.T) {
	got := BuildExtractAutoOnlyPrompt(7, "", false, "/home/test/.mygocode/memory/", "/tmp/proj/.mygocode/memory/")
...
func TestBuildExtractAutoOnlyPromptSkipIndex(t *testing.T) {
	got := BuildExtractAutoOnlyPrompt(5, "", true, "/home/test/.mygocode/memory/", "/tmp/proj/.mygocode/memory/")
...
func TestBuildExtractAutoOnlyPromptIncludesExistingManifest(t *testing.T) {
	...
	got := BuildExtractAutoOnlyPrompt(3, manifest, false, "/home/test/.mygocode/memory/", "/tmp/proj/.mygocode/memory/")
...
func TestBuildExtractAutoOnlyPromptNoTeamSection(t *testing.T) {
	...
	// must still never appear — MygoCode keeps the user/project split simple.
	got := BuildExtractAutoOnlyPrompt(3, "", false, "/home/test/.mygocode/memory/", "/tmp/proj/.mygocode/memory/")
