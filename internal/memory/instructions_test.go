...
func TestLoadInstructionsBasic(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "MYGOCODE.md"), "root mygocode rules")
	mustWrite(t, filepath.Join(dir, "AGENTS.md"), "root agents rules")
	mustWrite(t, filepath.Join(dir, ".mygocode", "INSTRUCTIONS.md"), "legacy instructions")

	out := LoadInstructions(dir)
	for _, want := range []string{"root mygocode rules", "root agents rules", "legacy instructions"} {
...
func TestLoadInstructionsWalksUp(t *testing.T) {
	...
	mustWrite(t, filepath.Join(root, "MYGOCODE.md"), "from root")
	mustWrite(t, filepath.Join(sub, "MYGOCODE.md"), "from leaf")
...
func TestExpandIncludesResolvesRelative(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "MYGOCODE.md"), "header\n@./rules/style.md\nfooter\n")
...
func TestExpandIncludesIgnoresCycles(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "MYGOCODE.md"), "@./a.md\n")
...
func TestExpandIncludesSkipsInsideCodeFences(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "MYGOCODE.md"), "```\n@./skipped.md\n```\n")
