...
func TestWorktreesDir(t *testing.T) {
	...
	want := filepath.Join("/tmp/repo", ".mygocode", "worktrees")
	if got != want {
...
func TestWorktreePathFor_FlattensNestedSlugs(t *testing.T) {
	...
	want := filepath.Join("/tmp/repo", ".mygocode", "worktrees", "team+alice")
	if got != want {
...
func TestGetOrCreateWorktree_RoundTrip(t *testing.T) {
	...
	if !strings.HasSuffix(r1.WorktreePath, filepath.Join(".mygocode", "worktrees", "feature-x")) {
...
func TestGetOrCreateWorktree_NestedSlug(t *testing.T) {
	...
	if !strings.HasSuffix(r.WorktreePath, filepath.Join(".mygocode", "worktrees", "team-refactor+alice")) {
